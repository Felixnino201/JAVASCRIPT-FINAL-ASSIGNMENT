window.addEventListener("load", (evt) => {
    ...
    const date = new Date();
    footerMes.innerText =`©FelixNino ${date.getFullYear()}` 
    ...
    inputForm.addEventListener("submit", (e) => {
        ...
        locationFinder(userCity).then((combinedData) => {
            if (combinedData === -1 && !nameInput.value) {
                ...
                mainInfoDiv.classList.add("col-lg-8", "col-sm-11", "d-flex", "justify-content-center", "flex-column", "text-center", "border", "border-secondary", "border-2", "rounded", "p-0");
                weathInfoDispDiv.classList.add("bg-secondary", "text-light", "mb-2");
                greetEle.classList.add("py-2", "m-0")
                countryFactMainDiv.classList.add("col-lg-3", "col-sm-11", "d-flex", "justify-content-center", "align-items-center", "flex-column", "text-center", "border", "border-success", "border-2", "rounded", "p-0", "bg-secondary-subtle");
                ...
                tempEle.classList.add("temp-val", "m-0", "p-2", "bg-secondary-subtle");
                weatherEle.classList.add("rain-main", "bg-secondary", "text-light", "m-0", "p-1");
                weatherDesEle.classList.add("m-0", "p-1", "bg-secondary-subtle");
                tempHeadEle.classList.add("bg-secondary", "text-light", "m-0", "py-1");
                cityEle.classList.add("m-0", "py-2", "bg-secondary-subtle");
                tempFeelsEle.classList.add("m-0", "py-1", "bg-secondary", "text-light");
                tempsFeelsValEle.classList.add("m-0", "py-1", "bg-secondarysubtle");
                tempMinEle.classList.add("m-0", "py-1", "bg-secondary", "text-light");
                tempMinValEle.classList.add("m-0", "py-1", "bg-secondary-subtle");
                tempMaxEle.classList.add("m-0", "py-1", "bg-secondary", "text-light");
                tempMaxValEle.classList.add("m-0", "py-1", "bg-secondary-subtle");
                pressureEle.classList.add("m-0", "py-1", "bg-secondary", "text-light");
                pressureValEle.classList.add("m-0", "py-1", "bg-secondary-subtle");
                humidityEle.classList.add("m-0", "py-1", "bg-secondary", "text-light");
                humidityValEle.classList.add("m-0", "py-1", "bg-secondary-subtle");
                windspeedEle.classList.add("m-0", "py-1", "bg-secondary", "text-light");
                windSpeedValEle.classList.add("m-0", "py-1", "bg-secondary-subtle");
                cloudEle.classList.add("m-0", "py-1", "bg-secondary", "text-light");
                cloudValEle.classList.add("m-0", "py-1", "bg-secondary-subtle");
                sunriseEle.classList.add("m-0", "py-1", "bg-secondary", "text-light");
                sunriseValEle.classList.add("m-0", "py-1", "bg-secondary-subtle");
                sunsetEle.classList.add("m-0", "py-1", "bg-psecondary", "text-light");
                sunsetValEle.classList.add("m-0", "py-1", "bg-secondary-subtle");
